<script setup>
  ...
  const myMap = new Map([ ['one', 10], ['two', 20] ]);
  ...
  <template>
    ...
    <div class="mb-3">
      ...
      <div class="box">
        <h5>2-2. v-else-if</h5>
        v-else-if와 v-else 사이에 다른 태그가 끼어 있으면 에러 발생. 항상 근접 태그로 기술 할 필요가 있다<br />
    ...
    <div class="mb-5">
      ...
      <button class="btn btn-outline-primary btn-sm" >IF</button>
      <button class="btn btn-outline-primary btn-sm" >Else IF</button>
      <button class="btn btn-outline-primary btn-sm" >Else</button><br>
    </div>  
    ...
    <div class="mb-3">
      ...
      <div class="form-check">
        ...
        <label class="form-check-label" :for="`set${idx}`">
          Default radio
        </label>
      </div>
    </div>
    ...
    <div class="mb-3">
      ...
      <div class="form-check">
        ...
        <label class="form-check-label" :for="`range${idx}`">
          Default radio
        </label>
      </div>
    </div>
    ...
    <div class="mb-3">
      ...
      <div class="form-check">
        ...
        <label class="form-check-label" :for="`str${idx}`">
          Default radio
        </label>
      </div>
    </div>
  ...
  <style scoped>
    .box { border: 1px solid lightgray; padding: 10px; border-radius: 10px;}
  </style>
